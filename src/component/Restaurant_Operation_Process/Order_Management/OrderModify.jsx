...
const ConfDiag = ({ openDia, handleDia, status }) => {
    return (
                ...
                (status == "Order Received") ?
                    <>
                        ...
                        <DialogActions>
                            ...
                            <Button href="/restaurantAdmin/orders" onClick={handleDia} color='error' sx={{ mr: 1 }}>Cancel</Button>
                    ...
                    <>
                        <DialogTitle >
                            {`This order already ${status}, you cannot Cancal.`}
                        </DialogTitle>
        ...
        <>
            ...
            >
                <Grid item xs={12} direction={'row'}>
                    <Typography><Link to="/restaurantAdmin/orders">Orders</Link> {"> Orders Modify"} </Typography>
                </Grid>
            ...
            <ConfDiag openDia={openDia} handleDia={handleDia} status={status} />
        </>
    );
}
