// material-ui
import { Box, Button, FormControlLabel, Typography, Card, Stack, Radio, RadioGroup, Dialog, DialogContent } from '@mui/material';
...
export default function PaymentOptionDialog ({isOpenDialog}) {
    ...
    return (
        <Dialog
            open={isOpenDialog}
            onClose={closePaymentOptionDialog}
            scroll={"paper"}
        ...
        >
            <DialogContent dividers={scroll === 'paper'} >
                <RadioGroup
                    ...
                    onChange={closePaymentOptionDialog}
