...
export default function DeliveryChatRoom() {

    const [userInput, setUserInput] = useState("")
    const users = [{}, {}, {}, {}, {}, {}]

    const [messages, setMessages] = useState([{ userType: "cust", message: "hello, i need help" }, { userType: "cs", message: "hello?" }]);
                                            ...
                                            <Card key={index} sx={{ p: 1, h: 200, borderRadius: '0px', boxShadow: 0, ":hover": { bgcolor: "aliceblue", cursor: "pointer" } }}>
                                                <Stack direction={'row'} justifyContent={'space-between'} alignItems={'center'} spacing={1}>
                                                    <Stack direction={'row'} alignItems={'center'} spacing={1}>
                                                        <Avatar sx={{ bgcolor: "#FFC0CB", width: 56, height: 56 }}>
                                ...
                                <Grid item xs={12} >
                                    {messages.map((m, index) => (
                                        <Typography
                                            ...
                                            mt={1}
                                            bgcolor={m.userType === 'cust' ? "#FFC0CB" : "#FFC0CB"}
                                            borderRadius={5}
